    ...
    return (
        <div className="px-4 py-5 z-50  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="relative flex grid items-center grid-cols-2 lg:grid-cols-3">
                ...
                <Link
                    to="/"
                    className="inline-flex items-center lg:mx-auto border-2 border-gray-800"
                >
                    <span className="text-xl font-bold tracking-wide bg-gray-800 px-2 text-white uppercase">
                        Course
                    </span>
